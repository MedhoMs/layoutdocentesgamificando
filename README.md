...
Rediseño de la página web Docentes Gamificando realizado en Statamic CLI Tool 3.6.1. Desarrolladores: Daniel Bucaloiu Morales (https://github.com/MedhoMs) & Airam Fuentes (https://github.com/Airamfuentes)

### English

Layout from Docentes Gamificando's web made with Statamic CLI Tool 3.6.1. Developers: Daniel Bucaloiu Morales (https://github.com/MedhoMs) & Airam Fuentes (https://github.com/Airamfuentes)
